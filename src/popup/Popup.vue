...
const sendCaptureEvent = () => {
  console.log('sendCaptureEvent')
  chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
    chrome.tabs.sendMessage(tabs[0].id, { action: 'captureVisibleTab' }, function (response) {
      console.log('sendCaptureEvent response', response)
    })
  })
}
</script>
...
<template>
  <main>
    ...
    <button @click="sendCaptureEvent">Test</button>
